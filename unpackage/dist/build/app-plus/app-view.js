...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'cu-bar bg-gradual-blue search'])
Z([3,'cu-avatar round'])
...
Z([3,'header'])
Z([3,'__e'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'Init']]]]]]]]])
Z([3,'综合'])
Z(z[1])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'Sell']]]]]]]]])
Z([3,'销量'])
Z(z[1])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'Price']]]]]]]]])
Z([3,'价格'])
Z([3,'wrap'])
Z([3,'left item'])
Z([3,'i'])
...
Z([3,'content_box'])
Z([3,'system'])
Z([3,'cu-bar bg-gradual-blue search fixed'])
Z([3,'search-form radius'])
Z([3,'cuIcon-search'])
Z([1,false])
Z([3,'__e'])
...
Z(z[13])
Z([3,'cuIcon-emoji text-red'])
Z([3,'大家都在搜'])
Z([3,'padding-xs bg-white solid-bottom margin-bottom'])
Z([3,'cu-tag radius margin-xs'])
Z([3,'游戏'])
Z(z[21])
Z([3,'张大仙'])
Z(z[21])
...
_(oP,xQ)
var oR=_mz(z,'input',['adjustPosition',4,'bindblur',1,'bindfocus',2,'confirmType',3,'data-event-opts',4,'placeholder',5,'type',6],[],e,s,gg)
_(oP,oR)
_(eN,oP)
var fS=_n('view')
...
_(eN,fS)
_(tM,eN)
var cW=_mz(z,'view',['class',14,'style',1],[],e,s,gg)
var oX=_mz(z,'swiper',['autoplay',16,'circular',1,'class',2,'duration',3,'indicatorDots',4,'interval',5],[],e,s,gg)
var lY=_v()
_(oX,lY)
...
var o6=_v()
_(x5,o6)
if(_oz(z,26,e2,t1,gg)){o6.wxVkey=1
var f7=_mz(z,'image',['mode',27,'src',1],[],e2,t1,gg)
_(o6,f7)
}
o6.wxXCkey=1
_(b3,x5)
...
_(cW,oX)
_(tM,cW)
var c8=_mz(z,'swiper',['autoplay',29,'bindchange',1,'circular',2,'class',3,'data-event-opts',4,'duration',5,'indicatorActiveColor',6,'indicatorColor',7,'indicatorDots',8,'interval',9],[],e,s,gg)
var h9=_v()
_(c8,h9)
var o0=function(oBB,cAB,lCB,gg){
var tEB=_n('swiper-item')
_rz(z,tEB,'class',43,oBB,cAB,gg)
var eFB=_n('view')
_rz(z,eFB,'class',44,oBB,cAB,gg)
var bGB=_v()
_(eFB,bGB)
if(_oz(z,45,oBB,cAB,gg)){bGB.wxVkey=1
var xIB=_mz(z,'image',['mode',46,'src',1],[],oBB,cAB,gg)
_(bGB,xIB)
}
var oHB=_v()
_(eFB,oHB)
if(_oz(z,48,oBB,cAB,gg)){oHB.wxVkey=1
var oJB=_mz(z,'video',['autoplay',-1,'loop',-1,'controls',49,'muted',1,'objectFit',2,'showPlayBtn',3,'src',4],[],oBB,cAB,gg)
_(oHB,oJB)
}
bGB.wxXCkey=1
oHB.wxXCkey=1
...
var eTB=_mz(z,'switch',['bindchange',63,'checked',1,'class',2,'data-event-opts',3],[],e,s,gg)
_(tSB,eTB)
_(cOB,tSB)
_(tM,cOB)
var bUB=_n('view')
...
var xWB=_mz(z,'navigator',['class',69,'hoverClass',1,'openType',2,'url',3],[],e,s,gg)
var oXB=_n('text')
...
var o4B=_mz(z,'text',['bindtap',1,'data-event-opts',1],[],e,s,gg)
var l5B=_oz(z,3,e,s,gg)
_(o4B,l5B)
_(c3B,o4B)
var a6B=_mz(z,'text',['bindtap',4,'data-event-opts',1],[],e,s,gg)
var t7B=_oz(z,6,e,s,gg)
_(a6B,t7B)
_(c3B,a6B)
var e8B=_mz(z,'text',['bindtap',7,'data-event-opts',1],[],e,s,gg)
...
var oHC=_n('view')
_rz(z,oHC,'class',16,hEC,cDC,gg)
var lIC=_v()
_(oHC,lIC)
if(_oz(z,17,hEC,cDC,gg)){lIC.wxVkey=1
var aJC=_mz(z,'image',['class',18,'mode',1,'src',2],[],hEC,cDC,gg)
_(lIC,aJC)
}
lIC.wxXCkey=1
_(oFC,oHC)
...
oBC.wxXCkey=2
_2z(z,14,fCC,e,s,gg,oBC,'item','i','i')
_(o0B,xAC)
var tKC=_n('view')
...
var cRC=_n('view')
_rz(z,cRC,'class',26,xOC,oNC,gg)
var hSC=_v()
_(cRC,hSC)
if(_oz(z,27,xOC,oNC,gg)){hSC.wxVkey=1
var oTC=_mz(z,'image',['class',28,'mode',1,'src',2],[],xOC,oNC,gg)
_(hSC,oTC)
}
hSC.wxXCkey=1
_(oPC,cRC)
...
eLC.wxXCkey=2
_2z(z,24,bMC,e,s,gg,eLC,'item','i','i')
_(o0B,tKC)
_(o2B,o0B)
_(r,o2B)
return r
...
_(tYC,eZC)
var b1C=_mz(z,'input',['adjustPosition',5,'bindblur',1,'bindfocus',2,'confirmType',3,'data-event-opts',4,'placeholder',5,'type',6],[],e,s,gg)
_(tYC,b1C)
_(aXC,tYC)
var o2C=_mz(z,'view',['bindtap',12,'class',1,'data-event-opts',2],[],e,s,gg)
var x3C=_n('text')
...
_(o0C,hKD)
var cMD=_n('view')
_rz(z,cMD,'class',33,e,s,gg)
var oND=_oz(z,34,e,s,gg)
_(cMD,oND)
_(o0C,cMD)
var lOD=_n('view')
...
var o2D=_mz(z,'view',['class',48,'style',1],[],e,s,gg)
_(c1D,o2D)
_(oZD,c1D)
_(hYD,oZD)
_(oVC,hYD)
...
_(o8D,fAE)
var hCE=_n('view')
_rz(z,hCE,'class',59,e,s,gg)
var oDE=_oz(z,60,e,s,gg)
_(hCE,oDE)
_(o8D,hCE)
var cEE=_n('view')
_rz(z,cEE,'class',61,e,s,gg)
var oFE=_oz(z,62,e,s,gg)
_(cEE,oFE)
_(o8D,cEE)
var lGE=_n('view')
_rz(z,lGE,'class',63,e,s,gg)
var aHE=_oz(z,64,e,s,gg)
_(lGE,aHE)
_(o8D,lGE)
var tIE=_n('view')
_rz(z,tIE,'class',65,e,s,gg)
var eJE=_oz(z,66,e,s,gg)
_(tIE,eJE)
_(o8D,tIE)
var bKE=_n('view')
...
_(o8D,xME)
var fOE=_n('view')
_rz(z,fOE,'class',71,e,s,gg)
var cPE=_oz(z,72,e,s,gg)
_(fOE,cPE)
_(o8D,fOE)
var hQE=_n('view')
...
var oTE=_oz(z,76,e,s,gg)
_(cSE,oTE)
_(o8D,cSE)
var lUE=_n('view')
_rz(z,lUE,'class',77,e,s,gg)
var aVE=_oz(z,78,e,s,gg)
_(lUE,aVE)
_(o8D,lUE)
_(oVC,o8D)
var tWE=_n('view')
...
var f3E=_n('view')
_rz(z,f3E,'class',84,e,s,gg)
var c4E=_oz(z,85,e,s,gg)
_(f3E,c4E)
_(o2E,f3E)
var h5E=_n('view')
_rz(z,h5E,'class',86,e,s,gg)
var o6E=_oz(z,87,e,s,gg)
_(h5E,o6E)
_(o2E,h5E)
var c7E=_n('view')
_rz(z,c7E,'class',88,e,s,gg)
var o8E=_oz(z,89,e,s,gg)
_(c7E,o8E)
_(o2E,c7E)
var l9E=_n('view')
_rz(z,l9E,'class',90,e,s,gg)
var a0E=_oz(z,91,e,s,gg)
_(l9E,a0E)
_(o2E,l9E)
var tAF=_n('view')
_rz(z,tAF,'class',92,e,s,gg)
var eBF=_oz(z,93,e,s,gg)
_(tAF,eBF)
_(o2E,tAF)
var bCF=_n('view')
...
_(o2E,bCF)
var xEF=_n('view')
_rz(z,xEF,'class',96,e,s,gg)
var oFF=_oz(z,97,e,s,gg)
_(xEF,oFF)
_(o2E,xEF)
var fGF=_n('view')
_rz(z,fGF,'class',98,e,s,gg)
var cHF=_oz(z,99,e,s,gg)
_(fGF,cHF)
_(o2E,fGF)
var hIF=_n('view')
...
var oLF=_oz(z,103,e,s,gg)
_(cKF,oLF)
_(o2E,cKF)
var lMF=_n('view')
_rz(z,lMF,'class',104,e,s,gg)
var aNF=_oz(z,105,e,s,gg)
_(lMF,aNF)
_(o2E,lMF)
var tOF=_n('view')
_rz(z,tOF,'class',106,e,s,gg)
var ePF=_oz(z,107,e,s,gg)
_(tOF,ePF)
_(o2E,tOF)
_(oVC,o2E)
var bQF=_n('view')
_rz(z,bQF,'class',108,e,s,gg)
var oRF=_n('view')
_rz(z,oRF,'class',109,e,s,gg)
var xSF=_n('text')
_rz(z,xSF,'class',110,e,s,gg)
_(oRF,xSF)
var oTF=_n('text')
var fUF=_oz(z,111,e,s,gg)
_(oTF,fUF)
_(oRF,oTF)
_(bQF,oRF)
_(oVC,bQF)
var cVF=_n('view')
_rz(z,cVF,'class',112,e,s,gg)
var hWF=_n('view')
_rz(z,hWF,'class',113,e,s,gg)
var oXF=_oz(z,114,e,s,gg)
_(hWF,oXF)
_(cVF,hWF)
var cYF=_n('view')
_rz(z,cYF,'class',115,e,s,gg)
var oZF=_oz(z,116,e,s,gg)
_(cYF,oZF)
_(cVF,cYF)
var l1F=_n('view')
_rz(z,l1F,'class',117,e,s,gg)
var a2F=_oz(z,118,e,s,gg)
_(l1F,a2F)
_(cVF,l1F)
var t3F=_n('view')
_rz(z,t3F,'class',119,e,s,gg)
var e4F=_oz(z,120,e,s,gg)
_(t3F,e4F)
_(cVF,t3F)
var b5F=_n('view')
_rz(z,b5F,'class',121,e,s,gg)
var o6F=_oz(z,122,e,s,gg)
_(b5F,o6F)
_(cVF,b5F)
var x7F=_n('view')
_rz(z,x7F,'class',123,e,s,gg)
var o8F=_oz(z,124,e,s,gg)
_(x7F,o8F)
_(cVF,x7F)
var f9F=_n('view')
_rz(z,f9F,'class',125,e,s,gg)
var c0F=_oz(z,126,e,s,gg)
_(f9F,c0F)
_(cVF,f9F)
var hAG=_n('view')
_rz(z,hAG,'class',127,e,s,gg)
var oBG=_oz(z,128,e,s,gg)
_(hAG,oBG)
_(cVF,hAG)
var cCG=_n('view')
_rz(z,cCG,'class',129,e,s,gg)
var oDG=_oz(z,130,e,s,gg)
_(cCG,oDG)
_(cVF,cCG)
var lEG=_n('view')
_rz(z,lEG,'class',131,e,s,gg)
var aFG=_oz(z,132,e,s,gg)
_(lEG,aFG)
_(cVF,lEG)
var tGG=_n('view')
_rz(z,tGG,'class',133,e,s,gg)
var eHG=_oz(z,134,e,s,gg)
_(tGG,eHG)
_(cVF,tGG)
var bIG=_n('view')
_rz(z,bIG,'class',135,e,s,gg)
var oJG=_oz(z,136,e,s,gg)
_(bIG,oJG)
_(cVF,bIG)
_(oVC,cVF)
_(r,oVC)
...
__wxAppCode__['pages/index/list.wxss']=setCssToHead([".",[1],"wrap{ display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; width:100%; margin-top:",[0,100],"; }\n.",[1],"header{ text-align: center; heihgt:",[0,100],"; line-height: ",[0,100],"; text-align: center; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-justify-content: space-around; -ms-flex-pack: distribute; justify-content: space-around; -webkit-box-align:center; -webkit-align-items:center; -ms-flex-align:center; align-items:center; position:fixed; width:100%; z-index: 100; background: #007AFF; }\n.",[1],"item{ width:50%; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-flex-shrink: 0; -ms-flex-negative: 0; flex-shrink: 0; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"left,.",[1],"right{ }\n.",[1],"item1{ width:90%; border-radius: ",[0,20],"; -webkit-box-shadow: 0 0 ",[0,10]," 0 rgba(0,0,0,.2); box-shadow: 0 0 ",[0,10]," 0 rgba(0,0,0,.2); margin:",[0,10]," 0; text-align: center; -webkit-box-sizing: border-box; box-sizing: border-box; }\n.",[1],"item2{ width:90%; border-radius: ",[0,20],"; -webkit-box-shadow: 0 0 ",[0,10]," 0 rgba(0,0,0,.2); box-shadow: 0 0 ",[0,10]," 0 rgba(0,0,0,.2); margin:",[0,10]," 0; text-align: center; -webkit-box-sizing: border-box; box-sizing: border-box; }\n.",[1],"image{ width: 80%; heihgt:auto; margin: ",[0,20]," auto; display: block; }\n",],undefined,{path:"./pages/index/list.wxss"});    
__wxAppCode__['pages/index/list.wxml']=$gwx('./pages/index/list.wxml');

__wxAppCode__['pages/index/search.wxss']=setCssToHead([".",[1],"content_box{ -webkit-box-sizing: border-box; box-sizing: border-box; padding-top: ",[0,100],"; }\n",],undefined,{path:"./pages/index/search.wxss"});    
